    ...
    public partial class Idb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ProductCategory", t => t.ProductID, cascadeDelete: true)
                .Index(t => t.OrderID)
                .Index(t => t.ProductID);
                ...
                c => new
                    {
                        ...
                        CategoryID = c.Int(nullable: false),
                        Image = c.String(maxLength: 256),
                        MorelImages = c.String(storeType: "xml"),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetails", "ProductID", "dbo.ProductCategory");
